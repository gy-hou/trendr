...
# 1.  环境检测
# ══════════════════════════════════════════════════════════════════
echo -e "${BLUE}${BOLD}[1/7] 检测基础环境...${NC}"
ERRORS=0
...
# 2.  Vault 路径配置
# ══════════════════════════════════════════════════════════════════
echo -e "${BLUE}${BOLD}[2/7] 配置输出路径...${NC}"
VAULT=""
...
# ══════════════════════════════════════════════════════════════════
echo -e "${BLUE}${BOLD}[3/7] 安装核心 Agents...${NC}"
...
# 4.  安装 Skills
# ══════════════════════════════════════════════════════════════════
echo -e "${BLUE}${BOLD}[4/7] 安装 Skills...${NC}"
...
# ══════════════════════════════════════════════════════════════════
echo -e "${BLUE}${BOLD}[5/7] 注册 Skills 到 openclaw.json...${NC}"
...
# 6.  初始化输出目录
# ══════════════════════════════════════════════════════════════════
echo -e "${BLUE}${BOLD}[6/7] 初始化输出目录...${NC}"
